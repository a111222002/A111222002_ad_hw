...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 設置字體顏色
        main_food.setTextColor(Color.RED); // 設置為紅色
        side_food.setTextColor(Color.RED); // 設置為紅色
        drink.setTextColor(Color.RED); // 設置為紅色
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                switch (spinner.getSelectedItemPosition()) {
                    case 0:
                        ...
                        main_food.setTextColor(Color.BLACK);
                        break;
                    case 1:
                        side_food.setText(selectedItem);
                        side_food.setTextColor(Color.BLACK);
                        break;
                    case 2:
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if (item.getItemId() == R.id.finish) {
            ...
            main_food.setTextColor(Color.RED); // 清除後設置為紅色
            side_food.setText("請選擇");
            side_food.setTextColor(Color.RED); // 清除後設置為紅色
            drink.setText("請選擇");
            drink.setTextColor(Color.RED); // 清除後設置為紅色
            return true;
        } else {
